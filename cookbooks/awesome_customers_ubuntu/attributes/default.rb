...
default_unless['awesome_customers_ubuntu']['database']['root_password'] = random_password
default_unless['awesome_customers_ubuntu']['database']['admin_password'] = random_password
